...
#define BPF_HASH_OF_MAPS(_name, _key_type)                                \
  BPF_MAP(_name, BPF_MAP_TYPE_HASH_OF_MAPS, _key_type, u32, 10240);
...
static __always_inline u32 *find(u64 target) {
...
static __always_inline void *backtrace(bpf_user_pt_regs_t *regs, u32 stack_id) {
