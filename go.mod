...
require (
	...
	github.com/grpc-ecosystem/go-grpc-middleware/providers/kit/v2 v2.0.0-rc.3 // indirect
	...
	github.com/polarsignals/frostdb v0.0.0-20221212142313-cd6396864829 // indirect
