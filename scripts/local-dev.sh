...
#        minikube start -p parca-agent --driver=virtualbox --kubernetes-version=v1.22.3 --cpus=4 --disk-size=80000mb --docker-opt dns=8.8.8.8
         minikube start -p parca-agent --driver=kvm2 --kubernetes-version=v1.22.3 --cpus=12 --memory=40gb --disk-size=120gb --docker-opt dns=8.8.8.8 --docker-opt default-ulimit=memlock=9223372036854775807:9223372036854775807
    fi
