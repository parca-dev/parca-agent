...
var AllMetrics = map[otelmetrics.MetricID]Metric {
	...
	otelmetrics.IDTraceEventReadError: {
		Desc:  "Number of times a trace event read failed (trace_events)",
		Field: "agent.errors.trace_event_read_error",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDErrProcParse: {
		Desc:  "Number of parsing errors seen during processing /proc/<PID>/maps",
		Field: "agent.errors.proc_parse",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDGoSymbolizationSuccess: {
		Desc:  "Number of successfully symbolized Go frames",
		Field: "agent.go.symbolization.successes",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDGoSymbolizationFailure: {
		Desc:  "Number of Go frames that failed symbolization",
		Field: "agent.go.symbolization.failures",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindGoLabelsAttempts: {
		Desc:  "Number of attempts to read Go custom labels",
		Field: "bpf.golabels.attempts",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindGoLabelsFailures: {
		Desc:  "Number of failures reading Go custom labels",
	...
	otelmetrics.IDUnwindNativeCustomLabelsAddSuccesses: {
		Desc:  "Number of successes adding native custom labels",
	...
	otelmetrics.IDUnwindNodeClFailedReadHmPointer: {
		Desc:  "Number of failures to read Node.js custom labels hashmap pointer",
		Field: "bpf.nodejs_custom_labels.errors.read_hm_pointer",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeClFailedNoLsInHm: {
		Desc:  "Number of failures when no Labelset found in Node.js custom labels hashmap",
		Field: "bpf.nodejs_custom_labels.errors.no_ls_in_hm",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeClFailedReadHmStruct: {
		Desc:  "Number of failures to read Node.js custom labels hashmap structure",
		Field: "bpf.nodejs_custom_labels.errors.read_hm_struct",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeClFailedReadBucket: {
		Desc:  "Number of failures to read Node.js custom labels bucket",
		Field: "bpf.nodejs_custom_labels.errors.read_bucket",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeClFailedReadLsAddr: {
		Desc:  "Number of failures to read Node.js custom labels Labelset address",
		Field: "bpf.nodejs_custom_labels.errors.read_ls_addr",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeClFailedTooManyBuckets: {
		Desc:  "Number of times too many buckets encountered in Node.js custom labels hashmap",
		Field: "bpf.nodejs_custom_labels.errors.too_many_buckets",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeClFailedGettingId: {
		Desc:  "Number of times we failed to get node.js execution async id",
		Field: "bpf.nodejs_custom_labels.errors.failed_getting_id",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeClWarnIdZero: {
		Desc:  "Number of times the node.js execution async id was zero",
		Field: "bpf.nodejs_custom_labels.warnings.id_zero",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeAsyncIdErrGetTlsSymbol: {
		Desc:  "Number of failures to get TLS symbol address for Node.js isolate",
		Field: "bpf.nodejs_async_id.errors.get_tls_symbol",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeAsyncIdErrReadIsolate: {
		Desc:  "Number of failures to read Node.js isolate pointer",
		Field: "bpf.nodejs_async_id.errors.read_isolate",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeAsyncIdErrReadContextHandle: {
		Desc:  "Number of failures to read Node.js context handle",
		Field: "bpf.nodejs_async_id.errors.read_context_handle",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeAsyncIdErrReadRealContextHandle: {
		Desc:  "Number of failures to read Node.js real context handle",
		Field: "bpf.nodejs_async_id.errors.read_real_context_handle",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeAsyncIdErrReadNativeContext: {
		Desc:  "Number of failures to read Node.js native context",
		Field: "bpf.nodejs_async_id.errors.read_native_context",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeAsyncIdErrReadEmbedderData: {
		Desc:  "Number of failures to read Node.js embedder data",
		Field: "bpf.nodejs_async_id.errors.read_embedder_data",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeAsyncIdErrReadEnvPtr: {
		Desc:  "Number of failures to read Node.js environment pointer",
		Field: "bpf.nodejs_async_id.errors.read_env_ptr",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeAsyncIdErrReadIdField: {
		Desc:  "Number of failures to read Node.js async ID field",
		Field: "bpf.nodejs_async_id.errors.read_id_field",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeAsyncIdErrReadIdDouble: {
		Desc:  "Number of failures to read Node.js async ID double value",
