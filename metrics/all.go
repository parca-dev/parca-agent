...
var AllMetrics = map[otelmetrics.MetricID]Metric {
	...
	otelmetrics.IDUnwindNodeCustomLabelsAttempts: {
		Desc:  "Number of attempts to read Node.js custom labels",
		Field: "bpf.node_custom_labels.attempts",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeCustomLabelsSuccesses: {
		Desc:  "Number of successful reads of Node.js custom labels",
		Field: "bpf.node_custom_labels.successes",
		Type:  MetricTypeCounter,
		Unit:  MetricUnitNone,
	},
	otelmetrics.IDUnwindNodeCustomLabelsFailures: {
		Desc:  "Number of failed attempts to read Node.js custom labels",
