...
func TestLabelsForTID_CPUCacheMismatch(t *testing.T) {
	...
	result1 := l.labelsForTID(tid, pid, libpf.Intern("myprocess"), 1, support.TraceOriginSampling, nil)
	...
	result2 := l.labelsForTID(tid, pid, libpf.Intern("myprocess"), 3, support.TraceOriginSampling, nil)
...
func TestLabelsForTID_ThreadMigrationPattern(t *testing.T) {
	...
	for i, cpu := range cpuSequence {
		result := l.labelsForTID(tid, pid, libpf.Intern("myprocess"), cpu, support.TraceOriginSampling, nil)
...
func TestLabelsForTID_DisableFlags(t *testing.T) {
	...
	t.Run("all enabled", func(t *testing.T) {
		...
		res := l.labelsForTID(tid, pid, libpf.Intern("myprocess"), 2, support.TraceOriginSampling, nil)
...
func TestLabelsForTID_ResourceSampleSplit(t *testing.T) {
	...
	res := l.labelsForTID(libpf.PID(1234), libpf.PID(1000),
		libpf.Intern("myprocess"), 2, support.TraceOriginSampling, nil)
	require.True(t, res.keep)
